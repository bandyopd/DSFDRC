...
A nice vignettee demonstrates the example of [TCGA-HNSC] (https://portal.gdc.cancer.gov/projects/TCGA-HNSC) data and can be installed with the package using 
the following codes:
```
devtools::install_github("urmiaf/ESFDRC",build_vignettes = TRUE)
```
## References
<a id="1">[1]</a> 
Ke, C., & Yin, X. (2020). 
